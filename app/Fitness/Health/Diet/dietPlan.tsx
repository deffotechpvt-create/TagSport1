  ...
  <View style={styles.line} />
      ...
      <View style={styles.mealCard}>
        ...
        <View style={styles.mealRight}>
          ...
          <Ionicons name="chevron-forward" size={24} color="#fff" onPress={()=>router.push('/Fitness/Health/Diet/shopping')}/>
        </View>
      </View>
      ...
      {/* Button */}
      <TouchableOpacity style={styles.buttonWrapper} onPress={()=> router.push('/Fitness/Health/Diet/dietForm')}>
        <LinearGradient
