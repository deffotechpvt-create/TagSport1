...
const HeartRate = () => {
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <TouchableOpacity onPress={() => router.push('/Fitness/Health/health')}>
            <Ionicons name="chevron-back" size={24} color="#fff" style={{top: -6, marginRight: 20}} />
          </TouchableOpacity>
      ...
      <TouchableOpacity activeOpacity={0.8} style={styles.buttonWrapper} onPress={()=> router.push('/Fitness/Health/health')}>
        <LinearGradient
